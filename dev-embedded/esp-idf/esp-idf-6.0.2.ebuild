...
RDEPEND="${DEPEND}
	...
	dev-python/pyparsing[${PYTHON_SINGLE_USEDEP}]
	dev-python/pyelftools[${PYTHON_SINGLE_USEDEP}]
	dev-python/idf-component-manager[${PYTHON_SINGLE_USEDEP}]
	dev-python/esp-coredump[${PYTHON_SINGLE_USEDEP}]
	dev-embedded/esptool[${PYTHON_SINGLE_USEDEP}]
	dev-python/esp-idf-kconfig[${PYTHON_SINGLE_USEDEP}]
	dev-python/esp-idf-monitor[${PYTHON_SINGLE_USEDEP}]
	dev-python/esp-idf-nvs-partition-gen[${PYTHON_SINGLE_USEDEP}]
	dev-python/esp-idf-size[${PYTHON_SINGLE_USEDEP}]
	dev-python/esp-idf-diag[${PYTHON_SINGLE_USEDEP}]
	dev-python/esp-idf-panic-decoder[${PYTHON_SINGLE_USEDEP}]
	dev-python/pyclang[${PYTHON_SINGLE_USEDEP}]
	dev-python/construct[${PYTHON_SINGLE_USEDEP}]
	dev-python/rich[${PYTHON_SINGLE_USEDEP}]
	dev-python/psutil[${PYTHON_SINGLE_USEDEP}]
	dev-python/tree-sitter[${PYTHON_SINGLE_USEDEP}]
	dev-python/tree-sitter-c[${PYTHON_SINGLE_USEDEP}]
...
src_install() {
	...
	cat > "${ED}/usr/bin/idf.py" <<-EOWRAPPER
		#!/bin/bash
		...
		exec "\${EPYTHON:-python3}" "/usr/share/esp-idf/tools/idf.py" "\$@"
	EOWRAPPER
	chmod +x "${ED}/usr/bin/idf.py" || die
