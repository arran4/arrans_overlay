...
SRC_URI="
  amd64? (  https://github.com/arran4/git-tag-inc/releases/download/v1.2.3/git-tag-inc_${PV}_linux_amd64.tar.gz -> ${P}-git-tag-inc_${PV}_linux_amd64.tar.gz  )  
  arm? (  https://github.com/arran4/git-tag-inc/releases/download/v1.2.3/git-tag-inc_${PV}_linux_armv7.tar.gz -> ${P}-git-tag-inc_${PV}_linux_armv7.tar.gz  )  
  arm64? (  https://github.com/arran4/git-tag-inc/releases/download/v1.2.3/git-tag-inc_${PV}_linux_arm64.tar.gz -> ${P}-git-tag-inc_${PV}_linux_arm64.tar.gz  )  
"
