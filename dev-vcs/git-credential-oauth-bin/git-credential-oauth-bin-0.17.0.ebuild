...
SRC_URI="
  amd64? (  https://github.com/hickford/git-credential-oauth/releases/download/v0.17.0/git-credential-oauth_${PV}_linux_amd64.tar.gz -> ${P}-git-credential-oauth_${PV}_linux_amd64.tar.gz  )  
  arm64? (  https://github.com/hickford/git-credential-oauth/releases/download/v0.17.0/git-credential-oauth_${PV}_linux_arm64.tar.gz -> ${P}-git-credential-oauth_${PV}_linux_arm64.tar.gz  )  
  x86? (  https://github.com/hickford/git-credential-oauth/releases/download/v0.17.0/git-credential-oauth_${PV}_linux_386.tar.gz -> ${P}-git-credential-oauth_${PV}_linux_386.tar.gz  )  
"
