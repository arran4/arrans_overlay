...
HOMEPAGE=""
SRC_URI="
  amd64? (  https://github.com/arran4/mvcommon/releases/download/v${PV}/mvcommon_${PV}_linux_amd64.tar.gz -> ${P}-mvcommon_${PV}_linux_amd64.tar.gz  )  
  arm64? (  https://github.com/arran4/mvcommon/releases/download/v${PV}/mvcommon_${PV}_linux_arm64.tar.gz -> ${P}-mvcommon_${PV}_linux_arm64.tar.gz  )  
"
LICENSE="MIT"
SLOT="0"
