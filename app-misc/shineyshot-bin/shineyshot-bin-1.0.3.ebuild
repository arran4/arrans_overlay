...
SRC_URI="
  amd64? (  https://github.com/arran4/shineyshot/releases/download/v1.0.3/shineyshot_${PV}_Linux_x86_64.tar.gz -> ${P}-shineyshot_${PV}_Linux_x86_64.tar.gz  )  
  arm? (  https://github.com/arran4/shineyshot/releases/download/v1.0.3/shineyshot_${PV}_Linux_armv7.tar.gz -> ${P}-shineyshot_${PV}_Linux_armv7.tar.gz  )  
  arm64? (  https://github.com/arran4/shineyshot/releases/download/v1.0.3/shineyshot_${PV}_Linux_arm64.tar.gz -> ${P}-shineyshot_${PV}_Linux_arm64.tar.gz  )  
  x86? (  https://github.com/arran4/shineyshot/releases/download/v1.0.3/shineyshot_${PV}_Linux_i386.tar.gz -> ${P}-shineyshot_${PV}_Linux_i386.tar.gz  )  
"
