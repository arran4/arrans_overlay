...
SRC_URI="
  amd64? ( https://github.com/ente-io/ente/releases/download/auth-v3.0.18-beta.2/ente-auth-v3.0.18-beta.2-x86_64.AppImage -> ${P}-ente-auth-auth-v3.0.18-beta.2-x86_64.AppImage )
"

src_unpack() {
  if use amd64; then
    cp "${DISTDIR}/${P}-ente-auth-auth-v3.0.18-beta.2-x86_64.AppImage" "auth.AppImage"  || die "Can't copy downloaded file"
  fi
