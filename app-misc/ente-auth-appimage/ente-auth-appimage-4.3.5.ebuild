...
SRC_URI="
  amd64? ( https://github.com/ente-io/ente/releases/download/auth-v4.3.5/ente-auth-v4.3.5-x86_64.AppImage -> ${P}-ente-auth-v4.3.5-x86_64.AppImage )
"

src_unpack() {
  if use amd64; then
    cp "${DISTDIR}/${P}-ente-auth-v4.3.5-x86_64.AppImage" "ente_auth.AppImage"  || die "Can't copy downloaded file"
  fi
