...
SRC_URI="
  amd64? (  https://github.com/Gaurav-Gosain/tuios/releases/download/v0.3.4/tuios_${PV}_Linux_x86_64.tar.gz -> ${P}-tuios_${PV}_Linux_x86_64.tar.gz  )  
  arm? (  https://github.com/Gaurav-Gosain/tuios/releases/download/v0.3.4/tuios_${PV}_Linux_armv7.tar.gz -> ${P}-tuios_${PV}_Linux_armv7.tar.gz  )  
  arm64? (  https://github.com/Gaurav-Gosain/tuios/releases/download/v0.3.4/tuios_${PV}_Linux_arm64.tar.gz -> ${P}-tuios_${PV}_Linux_arm64.tar.gz  )  
  x86? (  https://github.com/Gaurav-Gosain/tuios/releases/download/v0.3.4/tuios_${PV}_Linux_i386.tar.gz -> ${P}-tuios_${PV}_Linux_i386.tar.gz  )  
"
