...
SRC_URI="
  arm64? ( https://github.com/Bin-Huang/chatbox/releases/download/v0.10.4/Chatbox.CE-${PV}-arm64.AppImage -> ${P}-Chatbox-${PV}-arm64.AppImage )
  amd64? ( https://github.com/Bin-Huang/chatbox/releases/download/v0.10.4/Chatbox.CE-${PV}-x86_64.AppImage -> ${P}-Chatbox-${PV}-x86_64.AppImage )
"
