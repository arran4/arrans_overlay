...
SRC_URI="https://${MAID_SRC}/${PV}.tar.gz -> maid-${PV}.tar.gz \
	...
	https://${PUB}/fake_async-1.3.1.tar.gz \
	...
	https://${PUB}/leak_tracker-10.0.4.tar.gz \
	https://${PUB}/leak_tracker_flutter_testing-3.0.3.tar.gz \
	https://${PUB}/leak_tracker_testing-3.0.1.tar.gz \
	https://${PUB}/lints-3.0.0.tar.gz \
	https://${PUB}/logging-1.2.0.tar.gz \
	https://${PUB}/matcher-0.12.16+1.tar.gz \
	https://${PUB}/material_color_utilities-0.8.0.tar.gz \
	https://${PUB}/meta-1.12.0.tar.gz \
	...
	https://${PUB}/stack_trace-1.11.1.tar.gz \
	https://${PUB}/stream_channel-2.1.2.tar.gz \
	...
	https://${PUB}/test_api-0.7.0.tar.gz \
	...
	https://${PUB}/vector_math-2.1.4.tar.gz \
