...
SRC_URI="
  amd64? (  https://github.com/wader/fq/releases/download/v0.15.0/fq_${PV}_linux_amd64.tar.gz -> ${P}-fq_${PV}_linux_amd64.tar.gz  )  
  arm64? (  https://github.com/wader/fq/releases/download/v0.15.0/fq_${PV}_linux_arm64.tar.gz -> ${P}-fq_${PV}_linux_arm64.tar.gz  )  
"
