...
SRC_URI="
  amd64? (  https://github.com/arran4/rntocase/releases/download/v0.1.0/rntocase_${PV}_linux_amd64.tar.gz -> ${P}-rntocase_${PV}_linux_amd64.tar.gz  )  
  arm64? (  https://github.com/arran4/rntocase/releases/download/v0.1.0/rntocase_${PV}_linux_arm64.tar.gz -> ${P}-rntocase_${PV}_linux_arm64.tar.gz  )  
"
