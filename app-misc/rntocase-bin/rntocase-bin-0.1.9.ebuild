...
HOMEPAGE=""
SRC_URI="
  amd64? (  https://github.com/arran4/rntocase/releases/download/v${PV}/rntocase_${PV}_linux_amd64.tar.gz -> ${P}-rntocase_${PV}_linux_amd64.tar.gz  )  
  arm64? (  https://github.com/arran4/rntocase/releases/download/v${PV}/rntocase_${PV}_linux_arm64.tar.gz -> ${P}-rntocase_${PV}_linux_arm64.tar.gz  )  
"
LICENSE="MIT"
SLOT="0"
