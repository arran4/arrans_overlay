...
SRC_URI="https://${JULES_SRC}/v${PV}.tar.gz -> flutter-jules-${PV}.tar.gz \
	...
	https://${PUB}/characters-1.4.0.tar.gz \
	...
	https://${PUB}/matcher-0.12.17.tar.gz \
	https://${PUB}/material_color_utilities-0.11.1.tar.gz \
	https://${PUB}/menu_base-0.1.1.tar.gz \
	https://${PUB}/meta-1.17.0.tar.gz \
	...
	https://${PUB}/test_api-0.7.7.tar.gz \
	...
	https://${PUB}/vector_math-2.2.0.tar.gz \
