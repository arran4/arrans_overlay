...
SRC_URI="
  amd64? (  https://github.com/mudler/LocalAI/releases/download/v3.0.0/local-ai-Linux-x86_64 -> ${P}-local-ai-Linux-x86_64  )  
  arm64? (  https://github.com/mudler/LocalAI/releases/download/v3.0.0/local-ai-Linux-arm64 -> ${P}-local-ai-Linux-arm64  )  
"
