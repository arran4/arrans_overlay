...
SRC_URI="
  amd64? (  https://github.com/mudler/LocalAI/releases/download/v2.23.0/local-ai-Linux-x86_64 -> ${P}-local-ai-Linux-x86_64  )  
  amd64? (  https://github.com/mudler/LocalAI/releases/download/v2.23.0/stablediffusion -> ${P}-stablediffusion  )  
  arm64? (  https://github.com/mudler/LocalAI/releases/download/v2.23.0/local-ai-Linux-arm64 -> ${P}-local-ai-Linux-arm64  )  
"
