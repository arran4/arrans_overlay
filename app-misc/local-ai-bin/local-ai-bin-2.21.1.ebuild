...
SRC_URI="
  amd64? (  https://github.com/mudler/LocalAI/releases/download/v2.21.1/local-ai-Linux-x86_64 -> ${P}-local-ai-Linux-x86_64  )  
  amd64? (  https://github.com/mudler/LocalAI/releases/download/v2.21.1/stablediffusion -> ${P}-stablediffusion  )  
