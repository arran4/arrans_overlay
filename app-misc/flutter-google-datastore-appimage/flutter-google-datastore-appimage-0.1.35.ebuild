...
SRC_URI="
  amd64? ( https://github.com/arran4/flutter_google_datastore/releases/download/v0.1.35/flutter_google_datastore-0.1.35-linux.AppImage -> ${P}-flutter_google_datastore-${PV}-linux.AppImage )
"
