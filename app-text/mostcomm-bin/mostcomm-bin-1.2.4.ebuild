...
HOMEPAGE=""
SRC_URI="
	amd64? (  https://github.com/arran4/mostcomm/releases/download/v${PV}/mostcomm_${PV}_linux_amd64.tar.gz -> ${P}-mostcomm_${PV}_linux_amd64.tar.gz  )  
	arm? (  https://github.com/arran4/mostcomm/releases/download/v${PV}/mostcomm_${PV}_linux_armv7.tar.gz -> ${P}-mostcomm_${PV}_linux_armv7.tar.gz  )  
	arm64? (  https://github.com/arran4/mostcomm/releases/download/v${PV}/mostcomm_${PV}_linux_arm64.tar.gz -> ${P}-mostcomm_${PV}_linux_arm64.tar.gz  )  
"
LICENSE="MIT"
SLOT="0"
