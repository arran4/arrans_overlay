...
src_install() {
	# ensure the destination directory is created before copy
	dodir /opt/${PN}

	# preserve executable permissions for all files including the bundled python interpreters
	# doins -r strips executable bits, cp -a preserves them.
