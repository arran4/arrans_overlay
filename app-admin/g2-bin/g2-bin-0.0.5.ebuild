...
SRC_URI="
  amd64? (  https://github.com/arran4/g2/releases/download/v0.0.5/g2_${PV}_linux_amd64.tar.gz -> ${P}-g2_${PV}_linux_amd64.tar.gz  )  
  arm? (  https://github.com/arran4/g2/releases/download/v0.0.5/g2_${PV}_linux_armv6.tar.gz -> ${P}-g2_${PV}_linux_armv6.tar.gz  )  
  arm64? (  https://github.com/arran4/g2/releases/download/v0.0.5/g2_${PV}_linux_arm64.tar.gz -> ${P}-g2_${PV}_linux_arm64.tar.gz  )  
"
