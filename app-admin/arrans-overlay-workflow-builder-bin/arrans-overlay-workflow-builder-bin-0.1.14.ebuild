...
SRC_URI="
  amd64? (  https://github.com/arran4/arrans_overlay_workflow_builder/releases/download/v0.1.14/arrans_overlay_workflow_builder_${PV}_linux_amd64.tar.gz -> ${P}-arrans_overlay_workflow_builder_${PV}_linux_amd64.tar.gz  )  
"
