...
SRC_URI="
  amd64? (  https://github.com/arran4/arrans_overlay_workflow_builder/releases/download/v0.1.13/arrans_overlay_workflow_builder_${PV}_linux_amd64.tar.gz -> ${P}-arrans_overlay_workflow_builder_${PV}_linux_amd64.tar.gz  )  
"
