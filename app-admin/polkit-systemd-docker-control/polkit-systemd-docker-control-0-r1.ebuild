...
DESCRIPTION="Polkit rules for systemctl control of docker.service"
...
src_install() {
	...
	doins "${FILESDIR}/50-systemctl-docker.rules"
}

pkg_postinst() {
	elog "The Polkit policy for docker.service was installed."
