...
SRC_URI="
  ...
  arm? (  https://github.com/twpayne/chezmoi/releases/download/v${PV}/chezmoi_${PV}_linux_armv6.tar.gz -> ${P}-chezmoi_${PV}_linux_armv6.tar.gz  )  
...
src_unpack() {
  ...
  if use arm; then
    unpack "${DISTDIR}/${P}-chezmoi_${PV}_linux_armv6.tar.gz" || die "Can't unpack archive file"
  fi
