...
BORINGSSL_GOOGLE="https://boringssl.googlesource.com"
CHROMIUM_GOOGLE="https://chromium.googlesource.com"
DART_GOOGLE="https://dart.googlesource.com"
LLVM_GOOGLE="https://llvm.googlesource.com"
...
DART_DEPENDENCY_ARCHIVES=(
	...
	"dart-dep-clang-format-bb994c6f.tar.gz"
...
SRC_URI="
	...
	${BROWSER_DATA_GIT}/+archive/${BROWSER_DATA_REV}.tar.gz
		-> dart-dep-browser-data-ac8cae69.tar.gz
	${CLANG_FORMAT_GIT}/+archive/${CLANG_FORMAT_REV}.tar.gz
		-> dart-dep-clang-format-bb994c6f.tar.gz
	...
	${ICU_GIT}/+archive/${ICU_REV}.tar.gz
		-> dart-dep-icu-a86a32e6.tar.gz
	${JINJA2_GIT}/+archive/${JINJA2_REV}.tar.gz
		-> dart-dep-jinja2-2222b315.tar.gz
	${LEAK_TRACKER_GIT}/+archive/${LEAK_TRACKER_REV}.tar.gz
		-> dart-dep-leak-tracker-f5620600.tar.gz
	${LIBC_GIT}/+archive/${LIBC_REV}.tar.gz
		-> dart-dep-libc-5af39a19.tar.gz
	${LIBCXX_GIT}/+archive/${LIBCXX_REV}.tar.gz
		-> dart-dep-libcxx-bd557f6f.tar.gz
	${LIBCXXABI_GIT}/+archive/${LIBCXXABI_REV}.tar.gz
		-> dart-dep-libcxxabi-a4dda158.tar.gz
	${MARKUPSAFE_GIT}/+archive/${MARKUPSAFE_REV}.tar.gz
		-> dart-dep-markupsafe-8f45f5cf.tar.gz
	${NATIVE_GIT}/+archive/${NATIVE_REV}.tar.gz
		-> dart-dep-native-d51c5333.tar.gz
	${PERFETTO_GIT}/+archive/${PERFETTO_REV}.tar.gz
		-> dart-dep-perfetto-13ce0c9e.tar.gz
	${PLY_GIT}/+archive/${PLY_REV}.tar.gz
		-> dart-dep-ply-604b3259.tar.gz
...
BDEPEND="${PYTHON_DEPS}
	dev-build/gn
	dev-build/ninja
	=dev-lang/dart-bootstrap-bin-3.13.0_beta103_p1:3.13
"
