...
SRC_URI="
  amd64? (  https://github.com/rusq/slackdump/releases/download/v2.5.12/slackdump_Linux_x86_64.tar.gz -> ${P}-slackdump_Linux_x86_64.tar.gz  )  
  arm64? (  https://github.com/rusq/slackdump/releases/download/v2.5.12/slackdump_Linux_arm64.tar.gz -> ${P}-slackdump_Linux_arm64.tar.gz  )  
  x86? (  https://github.com/rusq/slackdump/releases/download/v2.5.12/slackdump_Linux_i386.tar.gz -> ${P}-slackdump_Linux_i386.tar.gz  )  
"
