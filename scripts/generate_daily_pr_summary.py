...
def main():
    ...
    parser.add_argument(
        "--body-output",
        type=Path,
        help="write the complete pull-request body to this file",
    )
    ...
    with redirect_stdout(summary_output):
        ...
        print_section("Metadata cache", cache_lines)
    ...
    if args.body_output:
        args.body_output.write_text(
            "This PR was auto-generated by the daily tasks workflow.\n\n" + summary
        )

    title = "Automated daily tasks (dedupe)"
