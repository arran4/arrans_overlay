...
SRC_URI="
	amd64? (  https://github.com/openai/codex/releases/download/rust-v0.148.0-alpha.12/codex-x86_64-unknown-linux-musl.tar.gz -> ${P}-codex-x86_64-unknown-linux-musl.tar.gz  )  
	arm64? (  https://github.com/openai/codex/releases/download/rust-v0.148.0-alpha.12/codex-aarch64-unknown-linux-musl.tar.gz -> ${P}-codex-aarch64-unknown-linux-musl.tar.gz  )  
"
LICENSE="MIT"
SLOT="0"
