...
SRC_URI="
  amd64? (  https://github.com/goreleaser/goreleaser/releases/download/v2.2.0/goreleaser_Linux_x86_64.tar.gz -> ${P}-goreleaser_Linux_x86_64.tar.gz  )  
  arm? (  https://github.com/goreleaser/goreleaser/releases/download/v2.2.0/goreleaser_Linux_armv7.tar.gz -> ${P}-goreleaser_Linux_armv7.tar.gz  )  
  arm64? (  https://github.com/goreleaser/goreleaser/releases/download/v2.2.0/goreleaser_Linux_arm64.tar.gz -> ${P}-goreleaser_Linux_arm64.tar.gz  )  
  ppc64? (  https://github.com/goreleaser/goreleaser/releases/download/v2.2.0/goreleaser_Linux_ppc64.tar.gz -> ${P}-goreleaser_Linux_ppc64.tar.gz  )  
  x86? (  https://github.com/goreleaser/goreleaser/releases/download/v2.2.0/goreleaser_Linux_i386.tar.gz -> ${P}-goreleaser_Linux_i386.tar.gz  )  
"
