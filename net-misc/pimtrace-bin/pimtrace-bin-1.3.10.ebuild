# Generated via: https://github.com/arran4/arrans_overlay/blob/main/.github/workflows/net-misc-pimtrace-bin-update.yaml
EAPI=8
...
SRC_URI="
  amd64? (  https://github.com/arran4/pimtrace/releases/download/v1.3.10/pimtrace_${PV}_linux_amd64.tar.gz -> ${P}-pimtrace_${PV}_linux_amd64.tar.gz  )  
  arm64? (  https://github.com/arran4/pimtrace/releases/download/v1.3.10/pimtrace_${PV}_linux_arm64.tar.gz -> ${P}-pimtrace_${PV}_linux_arm64.tar.gz  )  
"
