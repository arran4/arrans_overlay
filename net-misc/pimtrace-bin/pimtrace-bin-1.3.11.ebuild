...
HOMEPAGE=""
SRC_URI="
	amd64? (  https://github.com/arran4/pimtrace/releases/download/v${PV}/pimtrace_${PV}_linux_amd64.tar.gz -> ${P}-pimtrace_${PV}_linux_amd64.tar.gz  )  
	arm64? (  https://github.com/arran4/pimtrace/releases/download/v${PV}/pimtrace_${PV}_linux_arm64.tar.gz -> ${P}-pimtrace_${PV}_linux_arm64.tar.gz  )  
"
LICENSE="MIT"
SLOT="0"
